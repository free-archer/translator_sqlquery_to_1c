...
Функция RegExp(Шаблон, Текст, Global = Ложь, MultiLine = Ложь, IgnoreCase = Истина) Экспорт
	...
	Возврат "";
КонецФункции
Функция RegExpSubMatches(Шаблон, Текст, Global = Ложь, MultiLine = Ложь, IgnoreCase = Истина) Экспорт
	Перем RegExp;
	...
	Для Каждого Выражение Из РезультатАнализаСтроки Цикл
		...
		Для Каждого ПодВыражение Из Выражение.SubMatches Цикл
			МассивПодВыражений.Добавить(ПодВыражение);
		КонецЦикла;
		МассивВыражений.Добавить(МассивПодВыражений);
	КонецЦикла; 
...
Функция ВыделитьПсевдонимSQL(Знач Текст, ТаблицаSQL) Экспорт  
	Текст= СтрЗаменить(Текст, ТаблицаSQL, "");
	Текст= СокрЛП(Текст);  
